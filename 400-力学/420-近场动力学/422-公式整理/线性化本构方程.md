...
* 等价弹性矩阵
  $$
  {\mathbf K}_{\mathrm{pd}}({\boldsymbol x}) = \frac12 \int_{\mathcal H_\delta({\boldsymbol x})} c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} {{\mathrm d\!} V_{{\boldsymbol x}'}}
  $$
* 等价应变能密度
  $$
  W_{\mathrm{pd}}({\boldsymbol x}) = \frac12 \overline{\boldsymbol \varepsilon} : \frac12 \int_{\mathcal H_\delta({\boldsymbol x})} c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} {{\mathrm d\!} V_{{\boldsymbol x}'}} : \overline{\boldsymbol \varepsilon} 
  $$
...
* 先将应变与键的位移关系 ${\boldsymbol \eta} = \overline{\boldsymbol \varepsilon} {\boldsymbol \xi}$ 带入定义式，这样得到由应变场 ${\boldsymbol \varepsilon}({\boldsymbol x})$ 来表示的等效应变能密度，即
  ...
  &= \frac14 \int_{\mathcal H_\delta({\boldsymbol x})} c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} \bigl( \overline{\boldsymbol \varepsilon} {\boldsymbol \xi} \bigr)^{\mathrm T} {\boldsymbol \xi} \otimes {\boldsymbol \xi} \bigl( \overline{\boldsymbol \varepsilon} {\boldsymbol \xi} \bigr) {{\mathrm d\!} V_{{\boldsymbol x}'}} \\
  &= \frac14 \int_{\mathcal H_\delta({\boldsymbol x})} c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} \bigl( {\boldsymbol \xi}^{\mathrm T} \overline{\boldsymbol \varepsilon} \bigr) {\boldsymbol \xi} \otimes {\boldsymbol \xi} \bigl( \overline{\boldsymbol \varepsilon} {\boldsymbol \xi} \bigr) {{\mathrm d\!} V_{{\boldsymbol x}'}}
  \end{aligned}
  $$
...
* 将积分号内的式子化简，得到
  ...
  &= \frac14 \int_{\mathcal H_\delta({\boldsymbol x})} c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} \bigl( {\boldsymbol \xi}^{\mathrm T} \overline{\boldsymbol \varepsilon} \bigr) {\boldsymbol \xi} \otimes {\boldsymbol \xi} \bigl( \overline{\boldsymbol \varepsilon} {\boldsymbol \xi} \bigr) {{\mathrm d\!} V_{{\boldsymbol x}'}}
  && \\
  &= \frac14 \int_{\mathcal H_\delta({\boldsymbol x})} c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} \bigl( {\boldsymbol \xi}^{\mathrm T} \overline{\boldsymbol \varepsilon} \bigr) \bigl( {\boldsymbol \xi} \otimes {\boldsymbol \xi} \bigr) \overline{\boldsymbol \varepsilon} {\boldsymbol \xi} {{\mathrm d\!} V_{{\boldsymbol x}'}}
  &&\quad \bigl( \xi_i \overline\varepsilon_{ij} (\xi_j \xi_k) \overline\varepsilon_{kl} \xi_l \bigr) \\
  &= \frac14 \int_{\mathcal H_\delta({\boldsymbol x})} c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} \overline{\boldsymbol \varepsilon} : \bigl( {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} \bigr) : \overline{\boldsymbol \varepsilon} {{\mathrm d\!} V_{{\boldsymbol x}'}}
...
* 注意到积分号内，$\overline{\boldsymbol \varepsilon}$ 为常量，所以将其提出到积分号外
  ...
  W_{\mathrm{pd}}({\boldsymbol x})
  &= \frac14 \int_{\mathcal H_\delta({\boldsymbol x})} c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} \overline{\boldsymbol \varepsilon} : \bigl( {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} \bigr) : \overline{\boldsymbol \varepsilon} {{\mathrm d\!} V_{{\boldsymbol x}'}} \\
  &= \frac12 \overline{\boldsymbol \varepsilon} : \frac12\int_{\mathcal H_\delta({\boldsymbol x})} c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} {{\mathrm d\!} V_{{\boldsymbol x}'}} : \overline{\boldsymbol \varepsilon} \\
  ...
  &= \frac12\int_{\mathcal H_\delta({\boldsymbol x})} c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} {{\mathrm d\!} V_{{\boldsymbol x}'}}
  \end{aligned}
  $$
* 为了方便后面的描述，这里引入一些记号来方便后面的公式推导。定义单根键的等效刚度为 ${\mathbf K}_{\mathrm{bond}}({\boldsymbol \xi})$，单根键所储存的弹性能为 $\omega_{\mathrm{bond}}({\boldsymbol x}, {\boldsymbol \xi})$，其定义如下：
  $$
  \begin{aligned}
  {\mathbf K}_{\mathrm{bond}}({\boldsymbol \xi}) &= \frac12 c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi} \otimes {\boldsymbol \xi}\\
  ...
  = \frac12 c({\boldsymbol x}, {\boldsymbol \xi}) \xi^{-2} {\boldsymbol \eta}^{\mathrm T} ({\boldsymbol \xi} \otimes {\boldsymbol \xi}) {\boldsymbol \eta}
